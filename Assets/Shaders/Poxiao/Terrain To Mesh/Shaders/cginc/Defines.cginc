...
// If multiple layer-count keywords are enabled at once, keep the highest one.
#if defined(_T2M_LAYER_COUNT_16)
    #undef _T2M_LAYER_COUNT_3
    #undef _T2M_LAYER_COUNT_4
    #undef _T2M_LAYER_COUNT_5
    #undef _T2M_LAYER_COUNT_6
    #undef _T2M_LAYER_COUNT_7
    #undef _T2M_LAYER_COUNT_8
    #undef _T2M_LAYER_COUNT_9
    #undef _T2M_LAYER_COUNT_10
    #undef _T2M_LAYER_COUNT_11
    #undef _T2M_LAYER_COUNT_12
    #undef _T2M_LAYER_COUNT_13
    #undef _T2M_LAYER_COUNT_14
    #undef _T2M_LAYER_COUNT_15
